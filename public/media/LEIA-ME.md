...
├── grafismos/   1 grafismo da identidade     → src/dados/grafismos/derivados.ts
...
| `grafismos/` | elementos gráficos da identidade visual; **não** são registro de pesquisa | `carcara-identidade-368.webp` |
